      ...
      <div className="container">
        <div className="row align-items-center g-5">
                ...
                <div className="d-flex align-items-center gap-3">
                  <div
                    ...
                    style={{
                      ...
                      height: '60px',
                      background:
                        'linear-gradient(135deg, var(--rose-gold), var(--rose-gold-light))',
                    }}
                  >
                    <i
          ...
          <div className="col-lg-6">
            ...
            <h2 className="section-title text-start mb-4" style={{ marginTop: 0 }}>
              Meet{' '}
            ...
            <p style={{ color: 'var(--gray-text)', lineHeight: 1.8 }}>
              ...
              trusted name in the field of aesthetic medicine. His patient-centric
            ...
            <p style={{ color: 'var(--gray-text)', lineHeight: 1.8 }}>
              ...
              customized skincare regimens. Every patient receives individualized
              attention and care.
            </p>
