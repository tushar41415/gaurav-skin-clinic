...
const services = [
  ...
  {
    title: "Hair Fast Treatment & Scalp Therapy",
  ...
  {
    title: "Acne, Pimple & Acne Scars Treatment",
  ...
  {
    title: "Hydrafacial with Jelly & Sheet Mask",
  ...
  {
    title: "Skin Rejuvenation via Laser",
    img: "/images/service14.jpeg",
    tag: "Laser",
  },
  {
    title: "Pigmentation, Melasma & Dark Spot Care",
  ...
  {
    title: "Anti-Ageing & Wrinkle Care",
        ...
        {showHeader && (
          <div className="text-center">
            ...
            <h2 className="section-title">
              ...
              <span className="text-gradient">Hair & Skin</span>
            </h2>
            <p
              className="section-subtitle mx-auto"
              style={{ maxWidth: "680px" }}
            >
              Proven dermatology protocols with 15 years of experience,
              aesthetic procedures, and personalized treatment plans designed
