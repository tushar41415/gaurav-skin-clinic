...
const testimonials = [
  {
    ...
    avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=180",
  },
  {
    name: "Rahul Verma",
    ...
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=180",
  },
  {
    name: "Anita Gupta",
    ...
    avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=180",
  },
  {
    name: "Vikram Singh",
    ...
    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=180",
  },
];
    ...
    <section id="testimonials" className="section-padding">
      <div className="container">
        <div className="text-center mb-4 mb-lg-5">
          ...
          <h2 className="section-title">Stories from people who trusted Dr Derma</h2>
          <p className="section-subtitle mx-auto" style={{ maxWidth: "700px" }}>
            Patient feedback that reflects our commitment to safety, transparency, and real outcomes.
          </p>
        </div>
            ...
            >
              <article className="testimonial-card">
                ...
                <div className="client-info">
                  <img src={testimonial.avatar} alt={testimonial.name} className="client-avatar" loading="lazy" />
                  <div>
                    <h6 className="mb-1">{testimonial.name}</h6>
                    <small style={{ color: "var(--brand-2)", fontWeight: 600 }}>{testimonial.treatment}</small>
                  </div>
                </div>
              </article>
            </Motion.div>
